...
OpenRefine only displays a limited number of rows of data at one time. You can adjust it to up to 1,000 rows at the top left of the table of data. You can navigate through the records by using the previous/next/first/last navigation options at the top right of the table of data.
